...
4. Połączyć wszystkie zbiory w jeden, większy zbiór danych zawierający wszystkie wskaźniki oraz następujące kolumny: `kod`, `kazwa`, `rok` wykorzystując `pd.merge()`.
